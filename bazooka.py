...
class Bazooka(object):
    ...
    def __init__(self, master, x, y):
        ...
        self.buse = master.create_line(self.x1, self.y1, self.x2, self.y2,width =10)
        # dessiner ensuite le corps du canon par-dessus :
        r = 15                     # rayon du cercle
        master.create_oval(x-r, y-r, x+r, y+r, fill='blue', width =3)
    ...
    def orienter(self, angle):
            ...
            self.master.coords(self.buse, self.x1, self.y1, self.x2, self.y2)
